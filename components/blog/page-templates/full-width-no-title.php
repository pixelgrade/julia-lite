 ...
 *
 * The template for displaying full width pages without outputting the page title.
 *
 * This template can be overridden by copying it to a child theme or in the same theme
 * in `/page-templates/blog/full-width-no-title.php` or `/page-templates/full-width-no-title.php`
 *
...
$location = pixelgrade_set_location( 'page full-width no-title' );
if ( is_front_page() ) {
